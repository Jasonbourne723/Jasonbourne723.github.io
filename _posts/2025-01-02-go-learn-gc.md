...
![图1](/assets/img/go-gc/1.png)

2. 开始标记，程序找出它所有可达的对象，并做上标记。如下图所示,所以对象1-2-3、对象4-7等五个对象被做上标记。

![图2](/assets/img/go-gc/2.png)


3. 标记完了之后，然后开始清除未标记的对象. 结果如下:

![图3](/assets/img/go-gc/3.png)
...
![](/assets/img/go-gc/21.png)
![](/assets/img/go-gc/22.png)
![](/assets/img/go-gc/23.png)
![](/assets/img/go-gc/24.png)
![](/assets/img/go-gc/25.png)

但是如果栈不添加,当全部三色标记扫描之后,栈上有可能依然存在白色对象被引用的情况(如上图的对象9).  所以要对栈重新进行三色标记扫描, 但这次为了对象不丢失, 要对本次标记扫描启动STW暂停. 直到栈空间的三色标记结束.

![](/assets/img/go-gc/26.png)
![](/assets/img/go-gc/27.png)
![](/assets/img/go-gc/28.png)
...
![](/assets/img/go-gc/30.png)
![](/assets/img/go-gc/31.png)
![](/assets/img/go-gc/32.png)
![](/assets/img/go-gc/33.png)
![](/assets/img/go-gc/34.png)
![](/assets/img/go-gc/35.png)
![](/assets/img/go-gc/36.png)
...
![](/assets/img/go-gc/39.png)
![](/assets/img/go-gc/40.png)

##### 场景二： 对象被一个栈对象删除引用，成为另一个栈对象的下游

![](/assets/img/go-gc/41.png)
![](/assets/img/go-gc/42.png)
![](/assets/img/go-gc/43.png)


##### 场景三：对象被一个堆对象删除引用，成为另一个堆对象的下游

![](/assets/img/go-gc/44.png)
![](/assets/img/go-gc/45.png)
![](/assets/img/go-gc/46.png)


场景四：对象从一个栈对象删除引用，成为另一个堆对象的下游

![](/assets/img/go-gc/47.png)
![](/assets/img/go-gc/48.png)
![](/assets/img/go-gc/49.png)
